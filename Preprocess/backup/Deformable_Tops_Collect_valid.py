...
def FoldTops(env):
    ...
    manipulation_points, indices, points_similarity = env.model.get_manipulation_points(input_pcd=pcd, index_list=[957, 1425]) # [左袖口，右领口，右袖口，左领口，左下，右下]
...
def save_jsonl(env, pcd):
    ...
    manipulation_points, indices, points_similarity = env.model.get_manipulation_points(input_pcd=pcd, index_list=left_hem) 
